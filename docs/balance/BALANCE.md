...
| 1.2.0 | 2026-08-21 | Tech Lead | Adicionados parâmetros da TASK-106 e custos da TASK-107 |
...
| Ação | Custo de Energia | Custo de Fome | Quantidade de Recurso Gerada | Tempo de Cooldown |
|---|---:|---:|---:|---:|
| Coleta de Minério de Ferro | -10.0 Energia | -0.5 Fome | 1 a 2 Minérios | 1.0s |
| Forjar Lingote de Ferro | -15.0 Energia | -1.0 Fome | 1 Lingote | 2.5s |
| Descanso no Leito (1 hora) | +30.0 Energia | -2.0 Fome | N/A | Instantâneo |
...
| Energia (Energy) | 100.0 | Consumo por Ação (-10.0 Coleta) | Impede ações pesadas/coleta |
